  ...
  const testCases = [
    {
      id: '1',
      title: 'Simple Text',
      content: 'This is normal text without any special formatting.',
    },
    {
      id: '2',
      title: 'Single Hashtag',
      content: 'Check out this #awesome project!',
    },
    {
      id: '3',
      title: 'Single Mention',
      content: 'Hey @johndoe, how are you doing?',
    },
    {
      id: '4',
      title: 'Mixed Content',
    ...
    },
    {
      id: '7',
      title: 'Complex Mixed',
      content: 'Just finished our #CreatorCircle app! Big shoutout to @developer and @designer for the amazing work on #UI and #UX. The #collaboration was incredible!',
    },
    {
      id: '8',
      title: 'Edge Cases',
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <Text style={styles.header}>Text Alignment Test</Text>
        <Text style={styles.subtitle}>
          Testing that hashtags and mentions align properly with normal text
        </Text>
        ...
        <View style={styles.infoBox}>
          <Text style={styles.infoTitle}>Alignment Issues Fixed:</Text>
          <Text style={styles.infoText}>✅ Consistent font size (16px)</Text>
          <Text style={styles.infoText}>✅ Consistent line height (22px)</Text>
          <Text style={styles.infoText}>✅ Proper text baseline alignment</Text>
          <Text style={styles.infoText}>✅ Single Text component for consistent rendering</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
